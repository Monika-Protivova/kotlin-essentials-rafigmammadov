...
/*
  Implement the Assignment class.
...
class Assignment(
    ...
    // Private, mutable, and nullable finalGrade
    private var finalGrade: Int? = null

    // Method to set final grade with validation
...
fun main() {
    ...
    println(assignment.getFinalGrade()) // Output: 90
}
